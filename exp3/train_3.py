...
from exp3.model import ModelConfig, Model
from exp3.data_loader import get_training_dataloader, get_validation_dataloader
from exp3.validation import validate, estimate_train_loss
...
if __name__ == "__main__":
    ...
    model_config = ModelConfig(
        ...
        arcface_margin=torch.tensor(0.2),
        arcface_scale=32,
        loss_func='af' 
    )
    ...
    for epoch in range(0, n_epochs):
        ...
        torch.save({
            ...
            'eers': eers,
            'config': model_config
        },f"./checkpoints/train_1_2_epoch_{epoch}.pt")
