...
from train_3_3 import merge_sequences_overlap
from model_3_3 import Model, ModelConfig
...
if __name__ == "__main__":
    ...
    test_dataset_merged_file = f"1s_merged_test_users_data_tw10ms.pickle"
    cp_files = ["./exp3_3/train_3_3_epoch_49.pt"]
    ...
    if os.path.exists(test_dataset_merged_file) :
        ...
        test_dataset = merge_sequences_overlap(test_dataset, merge_length=100, overlap_length=50)
    ...
    for cp_file in cp_files:
        ...
        print(multi_results)
        import pickle
        with open(f"./exp3_3/res/multi_user_results_2.pickle",'wb') as outfile:
