...
from model_3_3 import ModelConfig, Model
...
if __name__ == "__main__":
    ...
    model_config = ModelConfig(
        ...
        seq_len= 100, # Block size/seq. length
    ...
    # Preprocessed files
    train_dataset_merged_file = f"1s_merged_training_users_data_tw10ms.pickle"
    val_dataset_merged_file = f"1s_merged_validation_users_data_tw10ms.pickle"
    ...
    # Resuming Training
    cp = torch.load("./exp3_3/train_3_3_epoch_39.pt", weights_only=False)
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        cosine_eer, maha_eer, *_ = validate(model=model, val_sequences=val_sequences, val_user_ids=val_user_ids, 
        ...
        torch.save({
            ...
            'eers': eers,
            'config': model_config
        },f"./exp3_3/train_3_3_epoch_{epoch + 20}.pt")
